...
namespace Selenium_Waits
{
    ...
    public class SeleniumWaits
    {
        ...
        public void AddBoxWhitoutWaitsFails()
        {
         ...
         //   wait.Until(ExpectedConditions.ElementIsVisible(By.CssSelector(".redbox")));
        ...
        [Test, Order(9)]
        public void AddBoxWhitExplicittWaitPasses()
        {
               WebDriverWait wait = new WebDriverWait(driver, TimeSpan.FromSeconds(5)); //explicit wait
            driver.FindElement(By.Id("adder")).Click();
               wait.Until(ExpectedConditions.ElementIsVisible(By.CssSelector(".redbox")));
        ...
        [Test, Order(10)]
        public void RevealInputWithExpllicitWaitPasses()
        {
            WebDriverWait wait = new WebDriverWait(driver, TimeSpan.FromSeconds(5));
            driver.FindElement(By.Id("reveal")).Click();
            wait.Until(ExpectedConditions.ElementIsVisible(By.Id("revealed")));
            var result = driver.FindElement(By.Id("revealed"));
